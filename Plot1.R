Plot1 <- function(){
  ...
  hist(dtAnalysis$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
  dev.copy(png, file=file.path(path, "Plot1.png"), width=480, height=480)
  dev.off()
