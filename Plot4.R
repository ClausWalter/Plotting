Plot4 <- function(){
  ...
  with(dtAnalysis, plot(supertime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
  with(dtAnalysis, plot(supertime,Sub_metering_1, type="n", xlab="", ylab="Energy sub metering"))
  lines(dtAnalysis$supertime, dtAnalysis$Sub_metering_1, col="black", type = "l")
  lines(dtAnalysis$supertime, dtAnalysis$Sub_metering_2, col="red", type = "l")  
  lines(dtAnalysis$supertime, dtAnalysis$Sub_metering_3, col="blue", type = "l")  
  legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd="1", col = c("black", "red", "blue"))
  with(dtAnalysis, plot(supertime,Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
  dev.copy(png, file=file.path(path, "Plot4.png"), width=480, height=480)
  dev.off()
}